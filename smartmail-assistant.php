...
Description: Provides AI-powered email assistance functionalities.
Version: 1.0
Author: Marco Zagato
...
// Shortcode Functions
function smartmail_email_categorization_shortcode($atts) {
    ob_start();
    ?>
...
function smartmail_priority_inbox_shortcode($atts) {
    ob_start();
    ?>
...
function smartmail_automated_responses_shortcode($atts) {
    ob_start();
    ?>
...
function smartmail_email_summarization_shortcode($atts) {
    ob_start();
    ?>
...
function smartmail_follow_up_reminders_shortcode($atts) {
    ob_start();
    ?>
...
function smartmail_email_templates_shortcode($atts) {
    ob_start();
    ?>
...
function smartmail_forensic_analysis_shortcode($atts) {
    ob_start();
    ?>
...
function smartmail_register_ajax_actions() {
    add_action('wp_ajax_smartmail_email_categorization', 'smartmail_email_categorization_ajax');
    add_action('wp_ajax_nopriv_smartmail_email_categorization', 'smartmail_email_categorization_ajax');

    add_action('wp_ajax_smartmail_priority_inbox', 'smartmail_priority_inbox_ajax');
    add_action('wp_ajax_nopriv_smartmail_priority_inbox', 'smartmail_priority_inbox_ajax');

    add_action('wp_ajax_smartmail_automated_responses', 'smartmail_automated_responses_ajax');
    add_action('wp_ajax_nopriv_smartmail_automated_responses', 'smartmail_automated_responses_ajax');

    add_action('wp_ajax_smartmail_email_summarization', 'smartmail_email_summarization_ajax');
    add_action('wp_ajax_nopriv_smartmail_email_summarization', 'smartmail_email_summarization_ajax');
    ...
    add_action('wp_ajax_smartmail_follow_up_reminders', 'smartmail_follow_up_reminders_ajax');
    add_action('wp_ajax_nopriv_smartmail_follow_up_reminders', 'smartmail_follow_up_reminders_ajax');

    add_action('wp_ajax_smartmail_sentiment_analysis', 'smartmail_sentiment_analysis_ajax');
    add_action('wp_ajax_nopriv_smartmail_sentiment_analysis', 'smartmail_sentiment_analysis_ajax');

    add_action('wp_ajax_smartmail_email_templates', 'smartmail_email_templates_ajax');
    add_action('wp_ajax_nopriv_smartmail_email_templates', 'smartmail_email_templates_ajax');

    add_action('wp_ajax_smartmail_forensic_analysis', 'smartmail_forensic_analysis_ajax');
    add_action('wp_ajax_nopriv_smartmail_forensic_analysis', 'smartmail_forensic_analysis_ajax');
}
add_action('init', 'smartmail_register_ajax_actions');

// AJAX handler functions
function smartmail_email_categorization_ajax() {
...
function smartmail_priority_inbox_ajax() {
    $email_content = sanitize_textarea_field($_POST['content']);
...
function smartmail_automated_responses_ajax() {
    $email_content = sanitize_textarea_field($_POST['content']);
...
function smartmail_email_summarization_ajax() {
    $email_content = sanitize_textarea_field($_POST['content']);
...
function smartmail_follow_up_reminders_ajax() {
    $email_content = sanitize_textarea_field($_POST['content']);
...
function smartmail_sentiment_analysis_ajax() {
    $email_content = sanitize_textarea_field($_POST['content']);
...
function smartmail_email_templates_ajax() {
    $email_content = sanitize_textarea_field($_POST['content']);
    $result = smartmail_email_templates($email_content);
    echo $result;
    wp_die();
}

function smartmail_forensic_analysis_ajax() {
    $email_content = sanitize_textarea_field($_POST['content']);
